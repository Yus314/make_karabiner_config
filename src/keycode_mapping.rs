...
fn get_hiragana_to_romaji_map() -> HashMap<&'static str, &'static str> {
    HashMap::from([
        ...
        ("わ", "wa"), ("ゐ", "wi"), ("ゑ", "we"), ("を", "wo"), // ゐ (wi), ゑ (we) は現代では稀
        ("ん", "n"),

        // 濁音
        ("が", "ga"), ("ぎ", "gi"), ("ぐ", "gu"), ("げ", "ge"), ("ご", "go"),
        ("ざ", "za"), ("じ", "ji"), ("ず", "zu"), ("ぜ", "ze"), ("ぞ", "zo"),
        ("だ", "da"), ("ぢ", "di"), ("づ", "du"), ("で", "de"), ("ど", "do"), // ぢ (di/ji), づ (du/zu)
        ...
        ("しゃ", "sha"), ("しゅ", "shu"), ("しょ", "sho"), // し (shi) ベース
        ("ちゃ", "cha"), ("ちゅ", "chu"), ("ちょ", "cho"), // ち (chi) ベース
        ...
        ("じゃ", "ja"), ("じゅ", "ju"), ("じょ", "jo"),   // じ (ji) ベース
        ("ぢゃ", "dya"), ("ぢゅ", "dyu"), ("ぢょ", "dyo"), // ぢ (di) ベース (じゃ、じゅ、じょ との区別)
